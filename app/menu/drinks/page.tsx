...
export default function Drinks() {
    const drinksData = menuData.drinks;
    ...
    return (
        <div className="min-h-screen bg-[#FFF2E6] overflow-x-hidden pt-24 md:pt-32 pb-20 relative">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
                ...
                >
                    <h1 className="text-5xl md:text-6xl fontchange text-[#7E4300] mb-4">Beverages</h1>
                    <div className="flex items-center justify-center gap-4">
                        <div className="h-0.5 w-12 bg-[#7E4300]/20"></div>
                        <span className="text-[#7E4300]/60 text-sm italic">Sip. Savor. Repeat.</span>
                        <div className="h-0.5 w-12 bg-[#7E4300]/20"></div>
                    </div>
                </motion.div>
                ...
                <div className="space-y-16">
                    ...
                    {Object.entries(drinksData).map(([key, category]: [string, any], index) => (
                        <MenuSection
                            key={key}
...
interface MenuItem {
    ...
    price: string | number;
    description?: string;
    desc?: string; // Handle potential inconsistent naming if any
}
            ...
            {items.map((item, idx) => (
                <div key={idx} className="group flex items-end justify-between gap-4">
                    <div className="flex-1">
                        ...
                        {/* <p className="text-black text-sm font-light italic">{item.desc}</p> */}
                    </div>
